...
(function (global) {
    ...
    function createMonthTable(data, option) {
        ...
        while (c <= 6) {
            ...
            //td.setAttribute("class",addclassactiveDate);
    ...
    function drawCalendarMonthTable(data, option) {
        ...
        if (option.prevnextbutton === "show") {
            ...
            elem.setAttribute("id", "change-month-prev");
            elem.setAttribute("onClick", 'myChangeMonthFunction(this)');
            elem.innerHTML = "&lt;";
        ...
        elem.setAttribute("id", "date-year");
        elem.setAttribute("onClick", 'myChangeMonthFunction(this)');
        ...
        if (option.prevnextbutton === "show") {
            ...
            elem.setAttribute("id", "change-month-next");
            elem.setAttribute("onClick", 'myChangeMonthFunction(this)');
            elem.innerHTML = "&gt;";
            //add prev button span to header div
            div.appendChild(elem);
     ...
     * @return objectconsole.log(strt[0]);
     */
    ...
    function getCalendar(year, month, date) {
        ...
        //result.today.monthNameFull = monthName.mmm[idx];
     ...
     */
     ...
     dycalendar.myChangeFunction = function(e){
        //console.log(e);
        var
        ...
        //exactDate = targetDomObject.getAttribute("5");
        ...
        option.month = month;
        option.year = year;
        //console.log(option.date,option.month,option.year, exactDate);
    ...
    function onClick() {
       // console.log("onclick");
        // document.getElementById('prev-id').onclick = function(e){
        //     console.log("kdjsklfs");
        // }
       // document.body.onclick = function (e) {
           ...
           // e = global.event || e;
            ...
            //var
                ...
                //other variables
               // date, month, year, btn, option, dateObj, exactDate;
    ...
    function drawCalendar(option) {
        ...
        switch (option.type) {
            case "day":
               ...
               // console.log(option.year, option.month, option.date);
                //get calendar html
